...
namespace DeMobile.Hubs
{
    public class MonitorHub : Hub
    {
        ...
        public void sendMessage(string url, string host, object request, object result)
        {
            ...
            context.Clients.All.Monitor(new { Url = url, ClientHostName = host, Parameter = request, Result = result, Time = DateTime.Now.ToString("dd/MM/yyyy") + " " + DateTime.Now.ToLongTimeString() });
        }
    }
}